              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full bg-zinc-950 border rounded-xl py-3 pl-10 pr-4 text-sm text-zinc-100 placeholder-zinc-600 focus:outline-none transition-colors ${errors.name
                ...
                <div className="flex gap-3 items-start">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className={`w-full bg-zinc-950 border rounded-xl py-3 pl-10 pr-4 text-sm text-zinc-100 placeholder-zinc-600 focus:outline-none transition-colors ${errors.imageUrl
                        ? "border-rose-500/70 focus:border-rose-500"
                        : "border-zinc-800 hover:border-zinc-700 focus:border-amber-500"
                        }`}
                    />
                ...
                {form.password && form.password.length > 0 && (
                  <div className="mt-2 flex gap-1.5">
                    {[...Array(4)].map((_, i) => (
                      <div
                        key={i}
                        className={`h-1 flex-1 rounded-full transition-colors ${form.password.length >= (i + 1) * 3
